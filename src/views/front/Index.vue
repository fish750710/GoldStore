<template>
  <div>    
    <!-- <router-link class="nav-link" to="/login">
     ...
     <!-- <button type="button" class="btn btn-primary" @click="openLogin">登入</button> -->
    

    <!-- <loading :active.sync="isLoading"></loading> -->
    <!-- <FrontNavbar/> -->
    <!-- <div class="text-right">{{ cart.carts.length }}</div> -->
    <!-- 輪播 -->
    <div id="carouselExampleIndicators" class="carousel slide  my-5 m-banner-rwd" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active banner-rwd">
          <a href="#" @click.prevent="goDetail('-LuQFEYmntflhE3g3af6')">
            <img src="@/assets/images/macbook_air__csdfieli984m_large.jpg" class="d-block w-100"  alt="...">
        ...
        <div class="carousel-item banner-rwd" >
          <a href="#" @click.prevent="goDetail('-LuQ9Z8JhBgR4O1L2Gb5')">
            <img src="@/assets/images/hero_iphone11_pro__je9i781j99u2_large.jpg" class="d-block w-100 "  alt="...">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item banner-rwd" >
          <a href="#" @click.prevent="goDetail('-LuQIo2AsSzBCxvJKok_')">
            <img src="@/assets/images/u19e_home_banner_desktop_bg_2000x683.jpg" class="d-block w-100 "  alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>HTC u19e</h5>
              <p>6吋 18:9 全屏大螢幕</p>
    ...
    <div class="container">
      <div class="row mt-4" >
        ...
        <!-- <div class="col-sm-12 col-md-12 m-menu-Sidebar ">
          <ul class="row h6 menu-ul mt-5">
            <li class="col-6 col-sm-3 col-md-3  pb-2"><a href="#" class="menuSidebar pb-1 d-flex justify-content-start" @click.prevent="badgeSearch('APPLE')">
              <i class="fab fa-apple pr-2"></i>APPLE</a></li>
            <li class="col-6 col-sm-3 col-md-3  pb-2"><a href="#" class="menuSidebar pb-1 d-flex justify-content-start" @click.prevent="badgeSearch('ASUS')">
              <i class="fas fa-microchip pr-2"></i>ASUS</a></li>
            <li class="col-6 col-sm-3 col-md-3  pb-2"><a href="#" class="menuSidebar pb-1 d-flex justify-content-start" @click.prevent="badgeSearch('HTC')">
              <i class="fas fa-glasses pr-2"></i>HTC</a></li>
            <li class="col-6 col-sm-3 col-md-3  pb-2"><a href="#" class="menuSidebar pb-1 d-flex justify-content-start" @click.prevent="badgeSearch('小米')">
              <i class="fas fa-robot pr-2"></i>mi</a></li>
          </ul>
        </div>  -->

        <swiper class="m-menu-Sidebar mt-5 pt-1 pb-2 menu-ul">
          <swiper-slide class="mr-3 ml-2 pt-1" style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('APPLE')">
              <i class="fab fa-apple pr-2"></i>APPLE</a>
          </swiper-slide>
          <swiper-slide class="mr-3 ml-2 pt-1"  style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('ASUS')">
              <i class="fas fa-microchip pr-2"></i>ASUS</a>
          </swiper-slide>
          <swiper-slide class="mr-3 ml-2 pt-1"  style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('HTC')">
              <i class="fas fa-glasses pr-2"></i>HTC</a>
          </swiper-slide>
          <swiper-slide class="mr-3 ml-2 pt-1"  style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('小米')">
              <i class="fas fa-robot pr-2"></i>mi</a>
          </swiper-slide> 
        
          <swiper-slide class="mr-3 ml-2 pt-1"  style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('三星')">
              <i class="fas fa-robot pr-2"></i>三星</a>
          </swiper-slide> 
          <swiper-slide class="mr-3 ml-2 pt-1"  style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('NOKIA')">
              <i class="fas fa-robot pr-2"></i>NOKIA</a>
          </swiper-slide>  
          <swiper-slide class="mr-3 ml-2 pt-1"  style="border: 1px solid #50CBCB;max-width:44%"><a href="#" class="menuSidebar pl-4 " @click.prevent="badgeSearch('MOTO')">
              <i class="fas fa-robot pr-2"></i>MOTO</a>
          </swiper-slide>          
        </swiper>
        ...
        <div class="col-sm-12 col-md-12 col-lg-10">
          ...
          <div class="tab-content">
            <div class="row">
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 mb-4 item-hover" v-for="item in products" :key="item.id" >
              <div class="card border-0 shadow-sm " v-if="item.is_enabled != 0" >
                ...
                <div class="card-body pt-2 pb-2" style="min-height:130px">            
                  ...
                  <div class="d-flex justify-content-between" style="height:35px"> 
                    ...
                    <div>
                      <span class="badge badge-secondary float-right ml-2 mb-1">{{ item.category }}</span>
                ...
                <button type="button" class="btn btn-primary btn-sm col-12 cart-move"
                    ...
                    <i class="fas fa-spinner fa-pulse ttext-white" v-if="item.id === status.loadingItem"> </i>
            ...
            <!-- 分頁 -->
            <Pagin @postPage="getProducts" :getpagin="pagination" v-if="ProductAll"></Pagin>
          </div>
