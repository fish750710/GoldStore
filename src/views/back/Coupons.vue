<template>
    <div>
        ...
        <div class="text-right mt-3">
            <button class="btn btn-outline-dark" @click="openCouponModel(true)">建立新的優惠卷</button>
        </div>
                        ...
                        <div class="col-sm-12">    
                            <div class="form-group">
                                <label for="name">優惠名稱</label>
                                    ...
                                    placeholder="優惠名稱" v-model="tempCoupons.title">
                            ...
                            <div class="form-row">                            
                                <div class="form-group col-md-3">
                                    ...
                                    placeholder="折扣碼" v-model="tempCoupons.code" >
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="percent">折扣百分比</label>
                                    <input type="number" class="form-control" id="percent"
                                    placeholder="折扣百分比" v-model="tempCoupons.percent" min="0" max="100">
                                </div>
                                <div class="form-group col-md-3">
                                <label for="due_date">到期日</label>
                                    <input type="date" class="form-control" id="due_date"
                                    placeholder="到期日" v-model="tempCoupons.due_date">
                                </div>
    ...
    methods:{
        getCoupons(page = 1 ){   
            ...
            this.$http.get(api).then((response) =>{
                ...
                vm.isLoading = false;
                vm.coupons = response.data.coupons; //儲存到變數裡面
