<template>
    <div>
        ...
        <!-- Modal -->
        <div class="modal fade modal-rwd" id="productModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4">
                        ...
                        class="img-fluid img-rwd" :src="tempProduct.imageUrl" alt="">
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                ...
                                placeholder="請輸入品牌" v-model="tempProduct.brand"> -->
                                <select class="custom-select custom-select-sm" v-model="tempProduct.brand" id="brand">                                                                      
                            ...
                            <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                ...
                                placeholder="請輸入類別" v-model="tempProduct.category">
                            </div>
                            <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                <label for="spec">規格</label>
                                <input type="text" class="form-control" id="spec"
                                placeholder="請輸入規格" v-model="tempProduct.spec">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-3">
                                ...
                                placeholder="請輸入數量" v-model="tempProduct.stock">
                            </div>
                            <div class="form-group col-sm-12 col-md-6 col-lg-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="content" rows="1"
                            ...
                            <div class="custom-control custom-switch">
                                <input class="custom-control-input align-middle" type="checkbox" 
...
export default {
    ...
    methods:{
        getProducts(page = 1){ //page 如未帶入數值，初始值=1
            ...
            this.$http.get(api).then((response) =>{
                ...
                vm.isLoading = false;
                vm.products = response.data.products; //儲存到變數裡面
    ...
    created(){ //hook 用來觸發getProducts事件
    //直接觸發
        this.getProducts();
