      ...
      <ul class="nav mb-2 col-10 col-sm-11 col-md-11 col-lg-10 justify-content-end">
        <li class="nav-item col-3 col-sm-3 col-md-2 col-lg-2 p-0">
          <router-link class="nav-link text-white menu-bar text-right pl-0 pr-0" to="/">
            ...
            <span class="pl-2">回賣場</span>
          </router-link>
        </li>
        <li class="nav-item col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2 p-0">
          <router-link
            class="nav-link text-white menu-bar text-right pl-0 pr-0"
            to="/admin/Products"
          >
            <i class="fas fa-box-open pr-1"></i>
            <span class="pl-2">產品列表</span>
          </router-link>
        </li>
        <li class="nav-item col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2 p-0">
        ...
        <li class="nav-item col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2 p-0">
          ...
          >
            ...
            <span class="pl-2">優惠卷</span>
          </router-link>
        </li>
        <li
          class="nav-item text-nowrap signout-rwd col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2 p-0 signout-ico"
        >
          <a class="nav-link text-light text-right" href="#" @click.prevent="signout">
